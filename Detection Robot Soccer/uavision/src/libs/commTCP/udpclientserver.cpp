...
namespace udp_client_server
{
     ...
     */
    int udp_client::send(const char *msge, size_t size)
    {
        return sendto(f_socket, msge, size, 0, f_addrinfo->ai_addr, f_addrinfo->ai_addrlen);
    }
     ...
     */
    int udp_server::recv(void* msg, int max_size)
    {
